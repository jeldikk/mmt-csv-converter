...
describe('OutputComponent', () => {
  ...
  it('should show spinner when loader published loading true and not when loading false', ()=>{
    ...
    fakeLoadingService.loading.next({isLoading: true, startedBy: 'validate', type: 'loading', message: 'message'});
    fixture.detectChanges();
  ...
  it('should render error component when operation failed', ()=>{
    ...
    fakeLoadingService.loading.next({isLoading: false, startedBy: 'validate', type: 'error', message: 'error message'});
    fixture.detectChanges();
  ...
  it('should render success component when operation is success', ()=>{
    ...
    fakeLoadingService.loading.next({isLoading: false, startedBy: 'convert', type: 'success', message: 'success-message'});
    fixture.detectChanges();
  ...
  it('should render info component when validate success', ()=>{
    ...
    fakeLoadingService.loading.next({isLoading: false, startedBy: 'validate', type: 'info', message: {}});
    fixture.detectChanges();
